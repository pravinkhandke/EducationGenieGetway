...
export class QuestionBankComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.questionBankService
                ...
                .subscribe(
                    (res: HttpResponse<IQuestionBank[]>) => this.paginateQuestionBanks(res.body, res.headers),
    ...
    registerChangeInQuestionBanks() {
        this.eventSubscriber = this.eventManager.subscribe('questionBankListModification', response => this.reset());
    }
    ...
    private paginateQuestionBanks(data: IQuestionBank[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        for (let i = 0; i < data.length; i++) {
            this.questionBanks.push(data[i]);
        }
    }
