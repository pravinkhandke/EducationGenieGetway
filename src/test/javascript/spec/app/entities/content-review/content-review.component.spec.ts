...
import { ContentReviewComponent } from 'app/entities/content-review/content-review.component';
...
describe('Component Tests', () => {
    describe('ContentReview Management Component', () => {
        let comp: ContentReviewComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ContentReviewComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.contentReviews[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
