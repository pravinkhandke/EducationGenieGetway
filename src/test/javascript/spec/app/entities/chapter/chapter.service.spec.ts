    ...
    describe('Chapter Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/chapters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Chapter', () => {
                service.create(new Chapter(null)).subscribe(received => {
            ...
            it('should update a Chapter', () => {
                service.update(new Chapter(123)).subscribe(received => {
